...
struct User: Identifiable, Codable, Hashable{
    ...
    var gender: String = GameMateGender.unspecified.rawValue
    var preference: String = GameMateGender.unspecified.rawValue
    ...
    static let mockUsers: [User] = [
        .init(id: NSUUID().uuidString, email: "a3@gmail.com", name: "Alice", age: 29, bio: "Alice's bio", profileImageUrl: "https://firebasestorage.googleapis.com:443/v0/b/tindercloneios-ca933.appspot.com/o/images%2F0CB9E8A4-E17E-48E2-9360-1EE3A83FF139?alt=media&token=2eb4299c-f02b-4bb6-908f-cc142af8216a",
        ...
        .init(id: NSUUID().uuidString, email: "u10@gmail.com", name: "u10", age: 29, bio: "u10bio", profileImageUrl: "ai_woman5"),
    ]
}
