    ...
    var body: some View {
        ...
        VStack {
            ...
            HStack {
                ...
                NavigationLink(destination: ProfileView(user: otherUser, isCurrentUser: otherUser.id == viewModel.currentUser?.id)) {
            ...
            .navigationDestination(for: User.self) { user in
                ProfileView(user: user, isCurrentUser: user.id == viewModel.currentUser?.id)
            }
